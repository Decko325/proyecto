			...
			<div class="col-sm-12">
				...
				<div class="card bg-light mb-3">
					<div class="card-header">
						<li class="fas fa-lock"></li> <strong>Base De Datos Ventas</strong>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-12">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmAgregarDatos">
						...
						<input type="text" id="IdVentas" name="IdVentas" class="form-control form-control-sm">
						<label>Fecha</label>
						...
						<label>Precio</label>
						<input type="text" id="valorapagar" name="valorapagar" class="form-control form-control-sm">
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="frmAgregarDatosu">
						...
						<label>IdVentas</label>
						<input type="text" id="idVentasu" name="idVentasu" class="form-control form-control-sm">
						<label>Fechas</label>
						...
						<label>Precio</label>
						<input type="text" id="valorapagaru" name="valorapagaru" class="form-control form-control-sm">
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
